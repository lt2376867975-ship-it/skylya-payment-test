...
export default function AppView({ onOpenMembership }) {
  return (
    <div className="tab-view warm-app-view">
      <header className="warm-app-hero">
        <div className="warm-app-hero__inner">
          <div className="warm-app-hero__copy">
            ...
            <button type="button" className="warm-button warm-button--light" onClick={onOpenMembership}>进入 Skylya <i>↗</i></button>
          </div>
      ...
      <ScrollRevealSection className="warm-app-coda">
        ...
        <div className="warm-app-coda__actions">
          <button type="button" className="warm-button warm-button--companion" onClick={onOpenMembership}>访问 Skylya <i>↗</i></button>
        </div>
      </ScrollRevealSection>
    </div>
  )
